...
- ### **Next.js**
    ...
    OKTO_CLIENT_API=108aa0df-eda6-46db-a4a7-df523ec8fd44
    GOOGLE_CLIENT_ID=932751577922-q16esqpu4dar7pkvcobh2ja220nvi7ql.apps.googleusercontent.com
    GOOGLE_CLIENT_SECRET=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
    ```
